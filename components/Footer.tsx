          ...
          <div className="flex flex-col md:items-end">
            <div className="flex flex-col space-y-8">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <a href="mailto:uniwaft@gmail.com" className="flex items-center gap-3 text-lg text-slate-600 dark:text-slate-400 hover:text-brand-primary dark:hover:text-brand-primary transition-colors">
                  <Mail className="w-5 h-5 flex-shrink-0" />
                  <span>uniwaft@gmail.com</span>
                </a>
              </div>
